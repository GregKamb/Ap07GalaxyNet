...
## 🌐 Live Demo
You can test the application live here: [Greg-GalaxyNet on Azure][Greg-GalaxyNet on Azure](https://greg-galaxynet-age6d0hshmdueghb.westeurope-01.azurewebsites.net)
## 🛠️ Technologies Used
